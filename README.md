...
|                                                                                                                                       |                                                                                                |
| [Paygate Adapter](https://github.com/eurofurence/reg-paygate-adapter)                                                                 | backend micro-service that interfaces between the registration system and the Nexi Paygate API |
|                                                                                                                                       |                                                                                                |
...
| [Frontend v2](https://github.com/eurofurence/reg-frontend-v2)                                                                         | Frontend for end user registration v2 (reimplementation using pure React, not yet in use)      |
